...
class BaseOptimizerEngine(ABCHasStrictTraits):
    ...
    User should be able to choose an Optimizer Engine, setup the optimization
    ...
    def _score(self, input_point):
        ...
        This method abstracts away the `single_point_evaluator`
        call from the rest of the OptimizerEngine methods and the user.
        This is also useful for the testing purposes, when the scoring
        method is mocked.
        """
