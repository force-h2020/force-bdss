...
class BaseDataSourceModel(BaseModel):
    ...
    def merge_slot_info(self, reassign=True):
        """Merge slot information on this object with corresponding
        BaseDataSource subclass generated by `factory`.
        Reassign input_slot_info or output_slot_info attributes
        ...
        reassign: bool (optional)
            Whether or not to reassign existing attributes, or just
    ...
    def verify(self):
        ...
        # Check return status of merge_slot_info method, whilst
        # leaving existing attributes unchanged
        try:
            self.merge_slot_info(reassign=False)
